...
#
# Output: flutter/skal_flutter/android/app/src/main/jniLibs/arm64-v8a/libskal.so
...
FLUTTER_NATIVE_LIBS="${SKAL_ROOT}/flutter/skal_flutter/android/app/src/main/jniLibs/arm64-v8a"
