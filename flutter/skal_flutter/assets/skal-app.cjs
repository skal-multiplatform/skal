...
(function() {
  ...
  var vr = (e, r) => e === r, nt = Symbol("solid-proxy"), br = typeof Proxy == "function", Er = Symbol("solid-track"), We = { equals: vr }, wt = null, Tt = At, Q = 1, Ae = 2, Rt = { owned: null, cleanups: null, context: null, owner: null }, D = null, T = null, xe = null, pe = null, H = null, X = null, J = null, He = 0;
  function Ge(e, r) {
    const n = H, o = D, l = e.length === 0, s = r === undefined ? o : r, d = l ? Rt : { owned: null, cleanups: null, context: s ? s.context : null, owner: s }, h = l ? e : () => e(() => le(() => ae(d)));
    D = d, H = null;
    try {
      return ie(h, true);
    } finally {
  ...
  function oe(e, r, n) {
    ...
    xe && T && T.running ? X.push(o) : ke(o);
  }
  function Sr(e, r, n) {
    Tt = Rr;
    const o = ot(e, r, false, Q), l = it && pr(it);
    l && (o.suspense = l), (!n || !n.render) && (o.user = true), J ? J.push(o) : ke(o);
  }
  function fe(e, r, n) {
    n = n ? Object.assign({}, We, n) : We;
    const o = ot(e, r, true, 0);
    return o.observers = null, o.observerSlots = null, o.comparator = n.equals || undefined, xe && T && T.running ? (o.tState = Q, X.push(o)) : ke(o), Ot.bind(o);
  }
  function le(e) {
    if (!pe && H === null)
      return e();
  ...
  function Fr(e) {
    ...
    return Promise.resolve().then(() => {
      H = r, D = n;
      let o;
      return (xe || it) && (o = T || (T = { sources: new Set, effects: [], promises: new Set, disposed: new Set, queue: new Set, running: true }), o.done || (o.done = new Promise((l) => o.resolve = l)), o.running = true), ie(e, false), H = D = null, o ? o.done : undefined;
    });
  }
  var [fi, Pt] = z(false);
  function pr(e) {
  ...
  function yt(e, r, n) {
    ...
    try {
      ...
      return e.pure && (T && T.running ? (e.tState = Q, e.tOwned && e.tOwned.forEach(ae), e.tOwned = undefined) : (e.state = Q, e.owned && e.owned.forEach(ae), e.owned = null)), e.updatedAt = n + 1, lt(d);
    } finally {
      H = s, D = l;
    }
  ...
  function ot(e, r, n, o = Q, l) {
    ...
    if (T && T.running && (s.state = 0, s.tState = o), D === null || D !== Rt && (T && T.running && D.pure ? D.tOwned ? D.tOwned.push(s) : D.tOwned = [s] : D.owned ? D.owned.push(s) : D.owned = [s]), pe && s.fn) {
      const d = s.fn, [h, O] = z(undefined, { equals: false }), w = pe.factory(d, O);
      mt(() => w.dispose());
      let m;
      const S = () => Fr(O).then(() => {
        m && (m.dispose(), m = undefined);
      });
      s.fn = (v) => (h(), T && T.running ? (m || (m = pe.factory(d, S)), m.track(v)) : w.track(v));
    }
    return s;
  }
  function $e(e) {
  ...
  function wr(e) {
    if (X && (xe && T && T.running ? Tr(X) : At(X), X = null), e)
      return;
    let r;
    if (T) {
  ...
  function Me(e, r) {
    ...
    for (let o = 0;o < e.sources.length; o += 1) {
      ...
      if (l.sources) {
        ...
        s === Q ? l !== r && (!l.updatedAt || l.updatedAt < He) && $e(l) : s === Ae && Me(l, r);
      }
    }
  }
  function xt(e) {
    ...
    for (let n = 0;n < e.observers.length; n += 1) {
      ...
      (r ? !o.tState : !o.state) && (r ? o.tState = Ae : o.state = Ae, o.pure ? X.push(o) : J.push(o), o.observers && xt(o));
    }
  }
  function ae(e) {
    let r;
  ...
  function lt(e, r = D) {
    const n = wt && r && r.context && r.context[wt], o = mr(e);
    if (!n)
      throw o;
    J ? J.push({ fn() {
      $t(o, n, r);
  ...
  function Or(e, r, n = {}) {
    ...
    return mt(() => It(s)), () => {
      ...
      return O[Er], le(() => {
        ...
        if (w === 0)
          d !== 0 && (It(s), s = [], o = [], l = [], d = 0, h && (h = [])), n.fallback && (o = [Pr], l[0] = Ge((x) => (s[0] = x, n.fallback())), d = 1);
        else if (d === 0) {
          ...
          for (S = F;S < w; S++)
            S in _ ? (l[S] = _[S], s[S] = V[S], h && (h[S] = M[S], h[S](S))) : l[S] = Ge(v);
  ...
  function Nt(...e) {
    ...
    for (let d = 0;d < e.length; d++) {
      const h = e[d];
      r = r || !!h && nt in h, e[d] = typeof h == "function" ? (r = true, fe(h)) : h;
    }
    if (br && r)
    ...
    for (let d = e.length - 1;d >= 0; d--) {
      ...
      for (let w = O.length - 1;w >= 0; w--) {
        ...
        if (!o[m])
          o[m] = S.get ? { enumerable: true, configurable: true, get: xr.bind(n[m] = [S.get.bind(h)]) } : S.value !== undefined ? S : undefined;
        else {
          const v = n[m];
  ...
  function se(e) {
    ...
    return fe(Or(() => e.each, e.children, r || undefined));
  }
  function $r(e) {
    const r = e.keyed, n = fe(() => e.when, undefined, undefined), o = r ? n : fe(n, undefined, { equals: (l, s) => !l == !s });
    return fe(() => {
      const l = o();
      if (l) {
        const s = e.children;
        return typeof s == "function" && s.length > 0 ? le(() => s(r ? l : () => {
          if (!le(o))
            throw kr("Show");
          return n();
        })) : s;
  ...
  var Ir = (e) => fe(() => e());
  function Nr({ createElement: e, createTextNode: r, isTextNode: n, replaceText: o, insertNode: l, removeNode: s, setProperty: d, getParentNode: h, getFirstChild: O, getNextSibling: w }) {
    function m(F, b, g, C) {
    ...
    return { render(F, b) {
      ...
      return d(F, b, g, C), g;
    }, mergeProps: Nt, effect: oe, memo: Ir, createComponent: yr, use(F, b, g) {
      return le(() => F(b, g));
    } };
  }
  function Dr(e) {
  ...
  var Dt = 6 * 1024 * 1024, Lr = 64, gi = Lr, Lt = 4 * 1024 * 1024, we = 64 + Lt, st = 768 * 1024, ct = we + st, Vr = 256 * 1024, ut = ct + Vr, Vt = we + st, Br = 0, zr = 8, Wr = 12, Hr = 16, Gr = 24, Mr = 28, Ur = 32, Xr = 40, Yr = 44, jr = zr >> 2, Jr = Wr >> 2, qr = Gr >> 2, Bt = Mr >> 2, Kr = Xr >> 2;
  Yr >> 2;
  var Qr = Br >> 3, Zr = Hr >> 3, en = Ur >> 3, hi = 1, di = 2, _i = 3, vi = 4, bi = 16, Ei = 17, Si = 20, Fi = 21, pi = 22, wi = 23, Ti = 24, Ri = 25, mi = 26, Pi = 27, Oi = 28, Ci = 29, yi = 30, Ai = 31, xi = 32, ki = 33, $i = 34, Ii = 35, Ni = 36, Di = 37, Li = 38, Vi = 0, Bi = 1, zi = 2, Wi = 3, Hi = 4, Gi = 5, Mi = 6, Ui = 7, Xi = 9, Yi = 10, ji = 11, Ji = 12, qi = 13, Ki = 14, Qi = 15, Zi = 16, eo = 17, to = 18, ro = 19, no = 20, io = 21, oo = 22, lo = 23, ao = 24, so = 1, co = 2, uo = 3, fo = 4, go = 5, ho = 6, _o = 7, vo = 8, bo = 9, Eo = 10, So = 11, Fo = 12, po = 0, wo = 1, To = 2, Ro = 3, mo = 4, Po = 5, Oo = 6, Co = 0, yo = 1, Ao = 2, xo = 3, ko = 4, $o = 5, Io = 6, No = 7, Do = 8, Lo = 9, Vo = 10, Bo = 11, zo = 12, Wo = 13, Ho = 14, Go = 15, Mo = 16, Uo = 32, Xo = 33, Yo = 34, jo = 35, Jo = 36, qo = 37, Ko = 64, Qo = 65, Zo = 66, el = 67, tl = 68, rl = 69, nl = 70, il = 71, ol = 96, ll = 97, al = 98, sl = 128, cl = 129, ul = 130, fl = 131, gl = 132, hl = 133, dl = 134, _l = 135, vl = 136, bl = 137, El = 160, Sl = 161, Fl = 162, pl = 163, wl = 164, Tl = 165, Rl = 166, ml = -1, tn = 2147483646, rn = 2147483645, ge = globalThis.__skal_acquireBridge();
  if (!ge || ge.byteLength !== Dt)
    throw new Error(`Skal: bridge buffer not available (got ${ge && ge.byteLength})`);
  var zt = new Uint8Array(ge), q = new Uint32Array(ge), ft = new BigInt64Array(ge), nn = new TextEncoder, Ie = 16, on = 64 + Lt >> 2, ln = 16384, an = on - 4, Xe = 0n, ce = Ie, Te = we, Ye = Ie;
  function gt() {
    q[jr] = ce - Ie << 2, q[Jr] = Te - we, Xe += 1n, Atomics.store(ft, Qr, Xe), Ye = ce;
  }
  function Wt() {
    gt();
    const e = Xe, r = performance.now() + 5000;
    for (;!(Atomics.load(ft, en) >= e); )
  ...
  function L(e, r, n, o) {
    let l = ce;
    l >= an && (Wt(), l = ce), q[l] = e >>> 0, q[l + 1] = r >>> 0, q[l + 2] = n >>> 0, q[l + 3] = o >>> 0, ce = l + 4, ce - Ye >= ln && gt();
  }
  var he = 0, de = 0;
  function Re(e) {
    Te + e.length * 3 > Vt && Wt();
    const r = Te - we, n = zt.subarray(Te, Vt), { read: o, written: l } = nn.encodeInto(e, n);
    if (o !== e.length)
  ...
  var K = 64, je = new Int32Array(te * K), Ne = new Float32Array(te * K), Je = new Array(te * K), De = new Uint8Array(te * K), me = 6, Pe = new Float32Array(te * me);
  Pe.fill(NaN);
  var qe = new Map, Ht = [], cn = 0;
  function un() {
    const e = te * 2, r = te * K, n = e * K, o = te * me, l = e * me, s = new Int32Array(n);
    s.set(je), je = s;
    const d = new Uint8Array(n);
    d.set(De), De = d;
    const h = new Float32Array(n);
    h.set(Ne), h.fill(NaN, r), Ne = h;
    const O = new Float32Array(l);
    O.set(Pe), O.fill(NaN, o), Pe = O, Je.length = n, te = e;
  }
  function Ke(e) {
    let r = qe.get(e);
    if (r === undefined) {
      r = Ht.pop(), r === undefined && (r = cn++), r >= te && un(), qe.set(e, r);
      const n = r * K;
      De.fill(0, n, n + K), Ne.fill(NaN, n, n + K);
      for (let o = n;o < n + K; o++)
        Je[o] = undefined;
    }
    return r;
  }
  var Gt = new Map, Mt = new Map, Ut = new Map, Oe = new Map;
  function fn(e) {
    const r = qe.get(e);
    if (r !== undefined) {
      qe.delete(e), Ht.push(r);
      const n = r * me;
      Pe.fill(NaN, n, n + me);
    }
    Gt.delete(e), Mt.delete(e), Ut.delete(e), On(e);
  }
  var Z = 0, ue = 0, Ce = new Float32Array(1), Le = new Uint32Array(Ce.buffer);
  function _e(e, r, n) {
    const o = n | 0, l = y[r];
    if (l < 0) {
      L(16, e, r, o), Z++;
    ...
    je[s] = o, De[s] = 1, L(16, e, r, o), Z++;
  }
  function Xt(e, r, n) {
    const o = y[r];
    if (o < 0) {
      Ce[0] = n, L(17, e, r, Le[0]), Z++;
      return;
    }
    const l = Ke(e) * K + o;
    if (Ne[l] === n) {
    ...
    Ne[l] = n, Ce[0] = n, L(17, e, r, Le[0]), Z++;
  }
  function gn(e, r, n) {
    const o = y[r];
    if (o < 0) {
      Re(n == null ? "" : String(n)), L(22, e, (r & 255) << 24 | he & 16777215, de), Z++;
      return;
    }
    const l = Ke(e) * K + o;
    if (Je[l] === n) {
    ...
    Je[l] = n, Re(n == null ? "" : String(n)), L(22, e, (r & 255) << 24 | he & 16777215, de), Z++;
  }
  function ye(e, r, n, o) {
    const l = Ke(e) * me + n;
    if (Pe[l] === o) {
  ...
  var Sn = { material: 0, cupertino: 1, adaptive: 2 }, Fn = { light: 0, dark: 1 };
  function pn(e, r) {
    L(38, typeof e == "string" ? Sn[e] ?? 0 : e | 0, typeof r == "string" ? Fn[r] ?? 0 : r | 0, 0), B();
  }
  function Yt(e) {
  ...
  function ve(e) {
    let r = Jt.get(e);
    return r !== undefined || (r = Tn(e), Re(e), L(23, r, he, de), Jt.set(e, r)), r;
  }
  function Rn(e, r) {
    L(4, e, ve(r), 0);
  }
  ...
  function Kt(e, r, n) {
    const o = ve(r), l = _t(Mt, e);
    if (l.get(o) === n) {
      ue++;
      return;
    }
    l.set(o, n), Ce[0] = n, L(25, e, o, Le[0]), Z++;
  }
  function Qt(e, r, n) {
    const o = ve(r), l = n == null ? "" : String(n), s = _t(Ut, e);
    if (s.get(o) === l) {
      ue++;
      return;
    }
    s.set(o, l), Re(l);
    const d = he & 16777215, h = de & 255;
    L(26, e, o, d << 8 | h), Z++;
  }
  function mn(e, r, n) {
    L(27, e, ve(r), n);
  }
  var Ve = new Map, re = new Map, Zt = 1;
  function er(e, r) {
    for (let n = 0;n < r.length; n++) {
      const o = r[n];
      if (typeof o == "number")
        Number.isInteger(o) ? L(29, e, 1, o | 0) : (Ce[0] = o, L(29, e, 2, Le[0]));
      else if (typeof o == "boolean")
        L(29, e, 3, o ? 1 : 0);
      else if (typeof o == "string") {
        Re(o);
        const l = he >>> 0;
        L(29, e, 4 | (de & 16777215) << 8, l);
      } else
        L(29, e, 0, 0);
    }
  }
  function Qe(e, r, n) {
    ...
    return er(l, n), L(28, e, o, l), B(), new Promise((s, d) => {
      Ve.set(l, { resolve: s, reject: d });
    });
  }
  function Pn(e, r, n, o, l) {
    const s = ve(r), d = Zt++;
    er(d, n), L(30, e, s, d), B(), re.set(d, { nodeId: e, onValue: o, onError: l && l.onError, onDone: l && l.onDone });
    let h = Oe.get(e);
    return h === undefined && (h = new Set, Oe.set(e, h)), h.add(d), function() {
      if (!re.has(d))
        return;
      re.delete(d);
      const w = Oe.get(e);
      w && (w.delete(d), w.size === 0 && Oe.delete(e)), L(31, d, 0, 0), B();
    };
  }
  function On(e) {
    const r = Oe.get(e);
  ...
  var bt = 0n, be = null, rr = Dt - ut, Et = ut >> 2, An = ut + rr >> 2, xn = rr / 16 | 0, nr = new ArrayBuffer(4), kn = new Float32Array(nr), $n = new Uint32Array(nr), In = new TextDecoder("utf-8");
  function St(e, r) {
  ...
  globalThis.__skal_drainEvents = function() {
    ...
    let s = xn;
    for (;n !== r && s-- > 0; ) {
      const d = q[n + 0], h = d & 255, O = d >>> 8 & 255, w = q[n + 1], m = q[n + 2], S = q[n + 3];
      let v, c = false;
      if (O === 1)
        v = m | 0, c = true;
      else if (O === 2)
      ...
      if (h === 3) {
        ...
        if (E) {
          ...
          try {
            ...
            be = _ && (_.stack || _.message || String(_)) || "unknown";
          }
        }
      } else if (h === 4) {
        const E = Ve.get(w);
    ...
    q[Bt] = n - l << 2, bt = e;
  }, globalThis.skalStatus = () => JSON.stringify({ handlerCount: vt.size, opSeq: Number(Xe), lastEventSeq: Number(bt), lastHandlerError: be, propWrites: Z, propSkips: ue });
  var Pl = 1, Nn = 2;
  function ir() {
    return Nn++;
  }
  var Dn = { box: 0, column: 1, scrollView: 5, listView: 6, reorderableListView: 7, row: 2, text: 3, button: 4, image: 9, stack: 10, switch: 11, slider: 12, checkbox: 13, activityIndicator: 14, progressBar: 15, lazyGrid: 16, wrap: 17, safeArea: 18, richText: 19, textInput: 20, navigator: 21, screen: 22, tabs: 23, tab: 24 }, Ln = { padding: [0, "u32"], paddingTop: [1, "u32"], paddingRight: [2, "u32"], paddingBottom: [3, "u32"], paddingLeft: [4, "u32"], width: [5, "dim"], height: [6, "dim"], weight: [7, "f32"], alignment: [8, "u32"], gap: [9, "u32"], axis: [10, "u32"], top: [11, "u32"], right: [12, "u32"], bottom: [13, "u32"], left: [14, "u32"], crossAxisCount: [15, "u32"], aspectRatio: [16, "f32"], background: [32, "color"], color: [33, "color"], cornerRadius: [34, "u32"], borderWidth: [35, "u32"], borderColor: [36, "color"], shadow: [37, "u32"], fontSize: [64, "u32"], fontWeight: [65, "u32"], fontFamily: [66, "u32"], textAlign: [67, "u32"], lineHeight: [68, "u32"], maxLines: [69, "u32"], textOverflow: [70, "u32"], src: [96, "str"], contentScale: [97, "u32"], placeholder: [128, "str"], value: [129, "str"], keyboardType: [130, "u32"], secureEntry: [131, "u32"], checked: [132, "u32"], min: [134, "f32"], max: [135, "f32"], progress: [136, "f32"], presentation: [166, "u32"], title: [71, "str"], icon: [98, "str"], activeTab: [137, "u32"], enabled: [160, "u32"], focusable: [161, "u32"], visible: [162, "u32"] }, Vn = { opacity: hn, translationX: dn, translationY: _n, scaleX: vn, scaleY: bn, rotation: En }, Bn = { onClick: 1, onclick: 1, onTap: 1, onLongPress: 8, onDoubleTap: 9, onChange: 2, onSubmit: 10, onReorder: 11, onPop: 12 }, zn = { linear: 0, easeIn: 1, easeOut: 2, easeInOut: 3, bounce: 4, elastic: 5, fastOutSlowIn: 6 };
  function Wn(e) {
    if (typeof e == "number")
      return e | 0;
    if (typeof e != "string")
  ...
  function Hn(e) {
    return typeof e == "number" ? e | 0 : e === "fill" ? tn : e === "wrap" ? rn : -1;
  }
  function Gn(e) {
    if (Array.isArray(e))
      return true;
  ...
  function Mn(e, r, n) {
    ...
    if (o === "number") {
      Number.isInteger(n) && n >= 0 && n <= 4294967295 && qt(e.id, r, n | 0), Kt(e.id, r, n), B();
      return;
    }
    if (o === "string") {
      Qt(e.id, r, n), B();
  ...
  var Ze = class {
  ...
  }, Xn = Dr({ createElement(e) {
    const r = ir(), n = Dn[e];
    return n !== undefined ? (L(1, r, n, 0), B(), new Ze(e, r, false, false)) : (Rn(r, e), B(), new Ze(e, r, false, true));
  }, createTextNode(e) {
    const r = ir();
    L(1, r, 3, 0);
    ...
    if (r === "animate" && n && typeof n == "object") {
      if (_e(e.id, 163, n.duration | 0), n.curve != null) {
        const h = typeof n.curve == "string" ? zn[n.curve] ?? 0 : n.curve | 0;
        _e(e.id, 164, h);
      }
      n.delay != null && _e(e.id, 165, n.delay | 0), B();
      return;
    }
    ...
    if (d !== undefined) {
      ...
      switch (O) {
        case "u32":
          typeof n == "number" ? (_e(e.id, h, n | 0), B()) : typeof n == "boolean" && (_e(e.id, h, n ? 1 : 0), B());
          return;
        case "f32":
          typeof n == "number" && (Xt(e.id, h, n), B());
          return;
        case "str":
          gn(e.id, h, String(n)), B();
          return;
        case "color":
          _e(e.id, h, Wn(n)), B();
          return;
    ...
    L(2, r.id, 0, 0), Un(r), B(), r.prevSibling ? r.prevSibling.nextSibling = r.nextSibling : e.firstChild = r.nextSibling, r.nextSibling ? r.nextSibling.prevSibling = r.prevSibling : e.lastChild = r.prevSibling, r.parent = null, r.prevSibling = null, r.nextSibling = null;
  }, isTextNode(e) {
    return e.isText;
  }, getParentNode(e) {
    return e.parent;
  ...
  } }), { render: Yn, effect: G, memo: Ol, createComponent: $, createElement: a, createTextNode: Cl, insertNode: p, insert: I, spread: yl, setProp: t, mergeProps: Al, use: jn } = Xn;
  L(1, 1, 0, 0), B();
  ...
  function Kn(e, r, n) {
    ...
    return s && d && Sr(() => {
      ...
      var v = a("navigator");
      return t(v, "onPop", () => S.back()), I(v, $(se, { get each() {
        return w();
      }, children: (c) => {
        const E = o(c.name);
        return (() => {
          var _ = a("screen");
          return I(_, E ? $(E, { get params() {
            return c.params || {};
          }, router: S }) : null), G((V) => {
  ...
  var or = "#FF0A84FF", lr = "#FF34C759", ar = "#FFFF9F0A", Qn = "#FFFF3B30", Zn = "#FF5E5CE6";
  function U(e) {
    return (() => {
      var r = a("column"), n = a("text");
      return p(r, n), t(r, "background", "#FFFFFFFF"), t(r, "cornerRadius", 14), t(r, "padding", 16), t(r, "gap", 12), t(r, "borderWidth", 1), t(r, "borderColor", "#FFE5E5EA"), t(n, "fontSize", 15), t(n, "fontWeight", 800), t(n, "color", "#FF1C1C1E"), I(r, () => e.children, null), G((o) => t(n, "label", e.title, o)), r;
    })();
  }
  function ei(e) {
    ...
    return (() => {
      var n = a("column");
      return t(n, "background", "#FFF2F2F7"), t(n, "padding", 16), t(n, "gap", 8), t(n, "height", "fill"), I(n, $(se, { each: r, children: (o) => (() => {
  ...
  function ri() {
    const [e, r] = z("material"), [n, o] = z(false), [l, s] = z(true), [d, h] = z(false), [O, w] = z(40), [m, S] = z(""), [v, c] = z(false), [E, _] = z("none yet"), [V, M] = z("\u2014 try a dialog button \u2014"), [F, b] = z(["First item", "Second item", "Third item", "Fourth item"]), g = Kn({ list: { component: (R) => $(ei, { get router() {
      return R.router;
    } }), title: "Mailboxes" }, detail: (R) => $(ti, { get name() {
    ...
    return (() => {
      ...
      } }), W), I(R, $(U, { title: "Layout \u2014 box \xB7 row \xB7 wrap", get children() {
        return [(() => {
          ...
          var i = a("wrap");
          return t(i, "gap", 6), I(i, $(se, { each: ["alpha", "beta", "gamma", "delta", "epsilon", "zeta", "eta", "theta", "iota", "kappa"], children: (u) => (() => {
      ...
      } }), W), I(R, $(U, { title: "Stack \u2014 overlap + positioned children", get children() {
      ...
      } }), W), I(R, $(U, { title: "Text & RichText", get children() {
        return [(() => {
          var i = a("text");
      ...
      } }), W), I(R, $(U, { title: "Image \u2014 network \xB7 BoxFit \xB7 rounded", get children() {
        return [(() => {
          var i = a("image");
      ...
      } }), W), I(R, $(U, { title: "Scrolling \u2014 horizontal list \xB7 lazy grid \xB7 reorderable", get children() {
        return [(() => {
          var i = a("text");
          return t(i, "label", "listView axis=1 (horizontal, virtualized):"), t(i, "fontSize", 11), t(i, "color", "#FF8E8E93"), i;
        })(), (() => {
          var i = a("listView");
          return t(i, "axis", 1), t(i, "height", 66), t(i, "gap", 8), I(i, $(se, { each: [or, lr, ar, Zn, Qn, "#FF00C7BE", "#FFAF52DE", "#FFFFD60A"], children: (u) => (() => {
            var f = a("box");
          ...
          var i = a("lazyGrid");
          return t(i, "crossAxisCount", 4), t(i, "aspectRatio", 1), t(i, "gap", 8), t(i, "height", 150), I(i, $(se, { get each() {
            return Array.from({ length: 12 }, (u, f) => f);
          }, children: (u) => (() => {
            var f = a("box");
            return t(f, "background", u % 3 === 0 ? or : u % 3 === 1 ? lr : ar), t(f, "cornerRadius", 8), f;
          })() })), i;
        })(), (() => {
          var i = a("text");
      ...
      } }), W), I(R, $(U, { title: "Controls \u2014 switch \xB7 checkbox \xB7 slider \xB7 text field", get children() {
        return [(() => {
      ...
      } }), W), I(R, $(U, { title: "Indicators \u2014 spinner \xB7 progress bar", get children() {
        return [(() => {
      ...
      } }), W), I(R, $(U, { title: "Animation \u2014 animate prop (Dart-side tween)", get children() {
        return [(() => {
          var i = a("row"), u = a("box");
          return p(i, u), t(i, "gap", 8), t(u, "width", 64), t(u, "height", 64), t(u, "background", "#FF0A84FF"), t(u, "cornerRadius", 14), t(u, "animate", { duration: 450, curve: "easeInOut" }), G((f) => {
            var P = v() ? 0.3 : 1, N = v() ? 1.4 : 1, Y = v() ? 1.4 : 1, Ee = v() ? 0.5 : 0, ne = v() ? 70 : 0;
            return P !== f.e && (f.e = t(u, "opacity", P, f.e)), N !== f.t && (f.t = t(u, "scaleX", N, f.t)), Y !== f.a && (f.a = t(u, "scaleY", Y, f.a)), Ee !== f.o && (f.o = t(u, "rotation", Ee, f.o)), ne !== f.i && (f.i = t(u, "translationX", ne, f.i)), f;
      ...
      } }), W), I(R, $(U, { title: "Gestures \u2014 onTap \xB7 onLongPress \xB7 onDoubleTap", get children() {
        return [(() => {
      ...
      } }), W), I(R, $(U, { title: "Dialogs \u2014 imperative JS API", get children() {
        return [(() => {
          ...
          return p(i, u), p(i, f), t(i, "gap", 8), t(u, "label", "Action sheet"), t(u, "onClick", async () => {
            M(`sheet \u2192 ${await wn({ title: "Choose an action", actions: [{ label: "Copy", value: "copy" }, { label: "Share", value: "share" }, { label: "Delete", value: "delete", style: "destructive" }] }) ?? "cancelled"}`);
      ...
      } }), W), I(R, $(U, { title: "Navigation \u2014 push / pop with keep-alive", get children() {
        return [(() => {
          var i = a("text");
      ...
      } }), W), I(R, $(U, { title: "Tabs \u2014 bottom bar with keep-alive", get children() {
        return [(() => {
          var i = a("text");
          ...
          var i = a("box"), u = a("tabs"), f = a("tab"), P = a("column"), N = a("text"), Y = a("text"), Ee = a("tab"), ne = a("column"), Be = a("text"), gr = a("textInput"), et = a("tab"), Se = a("column"), ze = a("text"), tt = a("text");
          return p(i, u), t(i, "height", 280), t(i, "borderWidth", 1), t(i, "borderColor", "#FFE5E5EA"), t(i, "cornerRadius", 8), p(u, f), p(u, Ee), p(u, et), t(u, "onChange", x), t(u, "height", "fill"), p(f, P), t(f, "title", "Home"), t(f, "icon", "home"), p(P, N), p(P, Y), t(P, "background", "#FFF2F2F7"), t(P, "padding", 16), t(P, "gap", 8), t(P, "height", "fill"), t(N, "label", "Home"), t(N, "fontSize", 20), t(N, "fontWeight", 800), t(N, "color", "#FF1C1C1E"), t(Y, "label", "Switch tabs and come back \u2014 this tab was never torn down."), t(Y, "fontSize", 13), t(Y, "color", "#FF8E8E93"), p(Ee, ne), t(Ee, "title", "Search"), t(Ee, "icon", "search"), p(ne, Be), p(ne, gr), t(ne, "background", "#FFF2F2F7"), t(ne, "padding", 16), t(ne, "gap", 8), t(ne, "height", "fill"), t(Be, "label", "Search"), t(Be, "fontSize", 20), t(Be, "fontWeight", 800), t(Be, "color", "#FF1C1C1E"), t(gr, "placeholder", "Type to search\u2026"), p(et, Se), t(et, "title", "Profile"), t(et, "icon", "person"), p(Se, ze), p(Se, tt), t(Se, "background", "#FFF2F2F7"), t(Se, "padding", 16), t(Se, "gap", 8), t(Se, "height", "fill"), t(ze, "label", "Profile"), t(ze, "fontSize", 20), t(ze, "fontWeight", 800), t(ze, "color", "#FF1C1C1E"), t(tt, "fontSize", 13), t(tt, "color", "#FF8E8E93"), G((Fe) => {
            var hr = C(), dr = `active tab index: ${C()}`;
            return hr !== Fe.e && (Fe.e = t(u, "activeTab", hr, Fe.e)), dr !== Fe.t && (Fe.t = t(tt, "label", dr, Fe.t)), Fe;
          }, { e: undefined, t: undefined }), i;
        })()];
      } }), W), I(R, $(U, { title: "SafeArea", get children() {
  ...
  function ai(e) {
    ...
    return (() => {
      ...
      return p(w, m), p(w, S), p(w, v), t(w, "background", "#FFFFFFFF"), t(w, "padding", 12), t(w, "cornerRadius", 10), t(w, "borderWidth", 1), t(w, "borderColor", "#FFE5E5EA"), t(w, "gap", 6), t(m, "fontWeight", 700), t(m, "fontSize", 14), t(m, "color", "#FF1DA1F2"), t(S, "fontSize", 14), t(S, "color", "#FF1F2937"), t(S, "maxLines", 3), t(S, "textOverflow", 1), p(v, c), p(v, E), t(v, "gap", 10), t(c, "fontSize", 12), t(c, "padding", 6), t(c, "cornerRadius", 16), t(c, "onClick", () => {
        ...
        var V = `#${e.num} \xB7 ${e.author}`, M = e.body, F = `\u2665 ${r()}`, b = o() ? oi : cr, g = o() ? fr : ur, C = `\u21A9 ${s()}`, x = h() ? li : cr, k = h() ? fr : ur;
  ...
  function si() {
    ...
    return (() => {
      ...
      })() })), t(w, "fontSize", 12), t(w, "color", "#FF8E8E93"), I(s, $(se, { get each() {
        return l();
      }, children: (m) => $(ai, { get author() {
        return m.author;
      }, get body() {
        return m.body;
      }, get num() {
  ...
  function ci() {
    const [e, r] = z("\u2014 waiting for counter events \u2014"), n = qn(), [o, l] = z("\u2014 tap a button to RPC the Ticker \u2014"), [s, d] = z(null), [h, O] = z(false);
    return (() => {
      var w = a("scrollView"), m = a("text"), S = a("text"), v = a("text");
      return p(w, m), p(w, S), p(w, v), t(w, "background", "#FFF2F2F7"), t(w, "padding", 16), t(w, "gap", 14), t(m, "label", "Libraries \u2014 codegen-wrapped widgets"), t(m, "fontSize", 24), t(m, "fontWeight", 800), t(m, "color", "#FF1C1C1E"), t(S, "label", "Custom adapters + real pub.dev packages, brought into JSX by skal_codegen. Imported from 'skal-flutter'."), t(S, "fontSize", 13), t(S, "color", "#FF8E8E93"), I(w, $(U, { title: "Greeting \u2014 hand-written adapter", get children() {
        var c = a("greeting");
        return t(c, "name", "Skal"), t(c, "color", "#FF1DA1F2"), t(c, "fontSize", 20), c;
      } }), v), I(w, $(U, { title: "Shimmer \u2014 pub.dev, named-ctor wrap", get children() {
        return [(() => {
          var c = a("text");
      ...
      } }), v), I(w, $(U, { title: "QR code \u2014 qr_flutter, pub.dev wrap", get children() {
        return [(() => {
          var c = a("qrImageView");
      ...
      } }), v), I(w, $(U, { title: "Camera \u2014 host-pattern wrap (controller lifecycle)", get children() {
        return [(() => {
          var c = a("text");
      ...
      } }), v), I(w, $(U, { title: "Counter \u2014 typed callbacks back to JSX", get children() {
        return [(() => {
          var c = a("counter");
      ...
      } }), v), I(w, $(U, { title: "Ticker \u2014 JS \u2192 Dart imperative RPC", get children() {
        return [(() => {
          var c = a("ticker");
          return jn(n, c), t(c, "intervalMs", 500), c;
        })(), (() => {
      ...
      } }), v), I(w, $(U, { title: "Stickers \u2014 List<Widget> children + gradient prop", get children() {
  ...
  function ui() {
    ...
    return (() => {
      ...
      return p(n, o), p(n, l), p(n, s), t(n, "onChange", r), t(n, "height", "fill"), t(o, "title", "UI"), t(o, "icon", "grid"), I(o, $(ri, {})), t(l, "title", "List"), t(l, "icon", "list"), I(l, $(si, {})), t(s, "title", "Libs"), t(s, "icon", "explore"), I(s, $(ci, {})), G((d) => t(n, "activeTab", e(), d)), n;
    })();
  }
  Yn(() => $(ui, {}), Jn);
})();
