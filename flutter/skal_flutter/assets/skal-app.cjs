...
(function() {
  ...
  var ni = (t, r) => t === r, Pe = Symbol("solid-proxy"), ii = typeof Proxy == "function", dr = Symbol("solid-track"), Bt = { equals: ni }, Jr = null, Yr = ln, Ee = 1, vt = 2, Zr = { owned: null, cleanups: null, context: null, owner: null }, Q = null, M = null, Et = null, tt = null, ne = null, se = null, fe = null, Mt = 0;
  function Wt(t, r) {
  ...
  function br(t, r, n, o = Ee, a) {
    ...
    if (M && M.running && (u.state = 0, u.tState = o), Q === null || Q !== Zr && (M && M.running && Q.pure ? Q.tOwned ? Q.tOwned.push(u) : Q.tOwned = [u] : Q.owned ? Q.owned.push(u) : Q.owned = [u]), tt && u.fn) {
      const d = u.fn, [b, h] = K(undefined, { equals: false }), p = tt.factory(d, h);
      en(() => p.dispose());
      let A;
      const P = () => li(h).then(() => {
        A && (A.dispose(), A = undefined);
      });
      u.fn = (D) => (b(), M && M.running ? (A || (A = tt.factory(d, P)), A.track(D)) : p.track(D));
    }
    return u;
  }
  function mt(t) {
    ...
    return en(() => un(u)), () => {
      ...
      return h[dr], Ie(() => {
        ...
        if (p === 0)
          ...
          for (P = T;P < p; P++)
            P in E ? (a[P] = E[P], u[P] = z[P], b && (b[P] = j[P], b[P](P))) : a[P] = Wt(D);
  ...
  var dn = 6 * 1024 * 1024, Si = 64, Pl = Si, hn = 4 * 1024 * 1024, rt = 64 + hn, vr = 768 * 1024, Er = rt + vr, mi = 256 * 1024, Sr = Er + mi, gn = rt + vr, wi = 0, yi = 8, xi = 12, Pi = 16, Ti = 24, Ri = 28, Ai = 32, $i = 40, Ci = 44, Oi = yi >> 2, ki = xi >> 2, Ii = Ti >> 2, _n = Ri >> 2, Di = $i >> 2;
  Ci >> 2;
  ...
  var bn = new Uint8Array(We), _e = new Uint32Array(We), mr = new BigInt64Array(We), Wi = new TextEncoder, wt = 16, Ui = 64 + hn >> 2, Vi = 16384, Hi = Ui - 4, Gt = 0n, ze = wt, nt = rt, jt = wt;
  function wr() {
    _e[Oi] = ze - wt << 2, _e[ki] = nt - rt, Gt += 1n, Atomics.store(mr, zi, Gt), jt = ze;
  }
  function pn() {
    wr();
  ...
  function it(t) {
    nt + t.length * 3 > gn && pn();
    const r = nt - rt, n = bn.subarray(nt, gn), { read: o, written: a } = Wi.encodeInto(t, n);
    if (o !== t.length)
  ...
  var Fe = 64, Kt = new Int32Array(Re * Fe), yt = new Float32Array(Re * Fe), Xt = new Array(Re * Fe), xt = new Uint8Array(Re * Fe), ot = 6, lt = new Float32Array(Re * ot);
  lt.fill(NaN);
  var Jt = new Map, Fn = [], ji = 0;
  function qi() {
    const t = Re * 2, r = Re * Fe, n = t * Fe, o = Re * ot, a = t * ot, u = new Int32Array(n);
    u.set(Kt), Kt = u;
    ...
    h.set(lt), h.fill(NaN, o), lt = h, Xt.length = n, Re = t;
  }
  function Yt(t) {
    let r = Jt.get(t);
    if (r === undefined) {
  ...
  var vn = new Map, En = new Map, Sn = new Map, at = new Map;
  function Ki(t) {
    const r = Jt.get(t);
    if (r !== undefined) {
  ...
  var we = 0, Ne = 0, st = new Float32Array(1), Pt = new Uint32Array(st.buffer);
  function he(t, r, n) {
    const o = n | 0, a = U[r];
    if (a < 0) {
      ee(16, t, r, o), we++;
  ...
  function mn(t, r, n) {
    ...
    yt[a] = n, st[0] = n, ee(17, t, r, Pt[0]), we++;
  }
  function Xi(t, r, n) {
    const o = U[r];
    if (o < 0) {
      it(n == null ? "" : String(n)), ee(22, t, (r & 255) << 24 | Ue & 16777215, Ve), we++;
      return;
    }
    const a = Yt(t) * Fe + o;
    if (Xt[a] === n) {
    ...
    Xt[a] = n, it(n == null ? "" : String(n)), ee(22, t, (r & 255) << 24 | Ue & 16777215, Ve), we++;
  }
  function ct(t, r, n, o) {
    const a = Yt(t) * ot + n;
    if (lt[a] === o) {
    ...
    lt[a] = o, st[0] = o, ee(r, t, 0, Pt[0]), we++;
  }
  function Ji(t, r) {
    ct(t, 32, 0, r);
  }
  ...
  function He(t) {
    let r = xn.get(t);
    return r !== undefined || (r = uo(t), it(t), ee(23, r, Ue, Ve), xn.set(t, r)), r;
  }
  function fo(t, r) {
    ee(4, t, He(r), 0);
  }
  ...
  function Tn(t, r, n) {
    ...
    a.set(o, n), st[0] = n, ee(25, t, o, Pt[0]), we++;
  }
  function Rn(t, r, n) {
  ...
  function $n(t, r) {
    for (let n = 0;n < r.length; n++) {
      const o = r[n];
      if (typeof o == "number")
        Number.isInteger(o) ? ee(29, t, 1, o | 0) : (st[0] = o, ee(29, t, 2, Pt[0]));
  ...
  function go(t, r, n, o, a) {
    ...
    return b === undefined && (b = new Set, at.set(t, b)), b.add(d), function() {
      ...
      Ae.delete(d);
      const p = at.get(t);
      p && (p.delete(d), p.size === 0 && at.delete(t)), ee(31, d, 0, 0), Y();
    };
  }
  function _o(t) {
    const r = at.get(t);
  ...
  function zr(t, r, n) {
    ...
    const [P, D] = K([{ name: A, params: {}, title: a(A), transition: u(A) }]), m = { stack: P, navigate(x, E, z) {
  ...
  var Qt = Symbol("store-raw"), ut = Symbol("store-node"), Ce = Symbol("store-has"), Dn = Symbol("store-self");
  function zn(t) {
    let r = t[Pe];
  ...
  function dt(t, r = new Set) {
    ...
    if (Array.isArray(t)) {
      ...
      for (let h = 0, p = d.length;h < p; h++)
        u = d[h], !b[u].get && (a = t[u], (o = dt(a, r)) !== a && (t[u] = o));
    }
    return t;
  }
  function er(t, r) {
  ...
  function No(t, r) {
    ...
    return !n || n.get || !n.configurable || r === Pe || r === ut || (delete n.value, delete n.writable, n.get = () => t[Pe][r]), n;
  }
  function Nn(t) {
    gr() && Rt(er(t, ut), Dn)();
  }
  ...
  var Bo = { get(t, r, n) {
    ...
    if (r === dr)
      return Nn(t), n;
    const o = er(t, ut), a = o[r];
    let u = a ? a() : t[r];
    if (r === ut || r === Ce || r === "__proto__")
      return u;
    if (!a) {
    ...
    return r === Qt || r === Pe || r === dr || r === ut || r === Ce || r === "__proto__" ? true : (gr() && Rt(er(t, Ce), r)(), (r in t));
  }, set() {
    return true;
  }, deleteProperty() {
    return true;
  ...
  function At(t, r, n = []) {
    ...
    let u = r[0];
    typeof u == "function" && (u = u(a, n), u === a) || o === undefined && u == null || (u = dt(u), o === undefined || ft(a) && ft(u) && !Array.isArray(u) ? Ln(a, u) : ht(t, o, u));
  }
  function Wo(...[t, r]) {
    const n = dt(t || {}), o = Array.isArray(n), a = zn(n);
    function u(...d) {
      Qr(() => {
  ...
  var tr = new WeakMap, Bn = { get(t, r) {
    ...
    const n = t[r];
    let o;
    return ft(n) ? tr.get(n) || (tr.set(n, o = new Proxy(n, Bn)), o) : n;
  }, set(t, r, n) {
  ...
  function ol(t, r = {}) {
    ...
    const [b, h] = Wo(gt(t)), [p, A] = K(false), [P, D] = K("\u2026"), [m, x] = K(null);
    let E = null;
    ...
    const ar = { ready: p, backendKind: P, initTiming: m, flushNow: V, version: () => n.version, pending: () => z.size, flushes: () => S, resident: () => pe.size, engineStats: () => E && E.stats ? E.stats() : null, createEffect: lr }, me = new Map;
    function Qe(R, F, v, O) {
      O === undefined && (O = Array.isArray(te(R)));
      const k = me.get(F);
      if (k !== undefined && k.isArray === O)
        return k.node;
      const C = O ? qr(R, F, v) : sr(R, F, v);
    ...
    function sr(R, F, v) {
      return new Proxy({}, { get(O, k) {
        ...
        const C = be(R, k);
        return C !== null && typeof C == "object" ? Qe(R.length === 0 ? [k] : [...R, k], F ? F + "." + k : k, v, Array.isArray(C)) : C;
      }, set(O, k, C) {
    ...
    function qr(R, F, v) {
      ...
      function C(c, g, ...y) {
        ...
        let q = y;
        if (v || (q = y.map((Z) => ve(Z) && Z._id == null ? { ...Z, _id: w(F) } : Z)), g === 0 && c === H && q.length > 0)
      ...
      function i(c, g) {
        ie(R, rr(c));
        const y = T.get(F);
        return g && !v && (y === undefined ? Xe(O()) : y) ? (z.set("k:" + F + "#x", ir), I()) : k(), ge.size > 0 && $e(F, true), O();
      }
      ...
      return new Proxy([], { get(c, g) {
        ...
        if (Vr(g)) {
          ...
          if (q !== null && typeof q == "object") {
            if (!v && q._id != null) {
              ...
              return Qe(xe, ce, { solidPath: xe, storeKey: ce }, false);
            }
            const re = de(F, g), Z = [...R, J];
            return v ? Qe(Z, re, v, Array.isArray(q)) : Qe(Z, re, { solidPath: R, storeKey: F }, Array.isArray(q));
          }
          return q;
        }
        const y = O(), W = y[g];
        ...
        if (Vr(g)) {
          const W = +g, H = O()[W];
          let J = y;
          !v && ve(y) && y._id == null && (J = { ...y, _id: H && H._id != null ? H._id : w(F) }), ie(R, W, J);
          let q = false;
          if (!v) {
            const re = T.get(F);
    ...
    function cr(R, F, v) {
      if (Array.isArray(R)) {
        ...
        const C = E.get("k:" + F);
        return C != null ? (v.push(F), ye(C)) : gt(R);
      }
      if (ve(R)) {
        const k = {};
      ...
      for (const O of Object.keys(R)) {
        ...
        if (Array.isArray(k))
          ...
          if (s.persist && !s.lazy && !z.has("k:" + i)) {
            ...
            if (g != null) {
              const y = ye(g);
              ie(C, y), ve(y) || (c = false, E.delPrefix && $.add(i));
            }
          }
          c && Lt(k, C, i);
        } else {
    ...
    async function Kr() {
      ...
      try {
        ...
        (!c || y !== n.version) && z.set("k:#meta", Ke({ version: n.version, shape: gt(t) })), O = Ct(), W || Lt(t, [], ""), I();
      } catch {}
  ...
  var ll = "#FFFFFFFF", al = "#FFE5E5EA", Gn = "#FF1C1C1E", jn = "#FF8E8E93", Oe = "#FF0A84FF", Le = "#FF34C759", Je = "#FFFF9F0A", Ot = "#FFFF3B30", _t = "#FF5E5CE6";
  function X(t) {
    return (() => {
  ...
  function fl() {
    ...
    const E = zr({ gallery: (z) => (() => {
      ...
      return _(j, T), _(j, f), e(j, "background", "#FFF2F2F7"), e(j, "padding", 16), e(j, "gap", 12), e(j, "height", "fill"), _(T, $), e($, "width", "fill"), e($, "height", 180), e($, "cornerRadius", 20), e(f, "label", "The swatch flew here from the gallery \u2014 a shared-element transition, GPU-composited host-side."), e(f, "fontSize", 13), e(f, "color", "#FF8E8E93"), G((S) => {
    ...
    return (() => {
      ...
      return _(z, j), _(z, T), _(z, $), e(z, "background", "#FFF2F2F7"), e(z, "padding", 16), e(z, "gap", 14), e(j, "label", "Animations"), e(j, "fontSize", 24), e(j, "fontWeight", 800), e(j, "color", "#FF1C1C1E"), e(T, "label", "Host-side motion \u2014 JS flips one signal, Flutter runs the whole tween. Zero per-frame bridge traffic. See ANIMATION.md for the full plan."), e(T, "fontSize", 13), e(T, "color", "#FF8E8E93"), B(z, L(X, { title: "Implicit hot-prop tween \u2014 the animate prop", get children() {
        ...
        return [(() => {
          ...
          return _(f, S), e(f, "height", 150), e(f, "background", "#FFEFEFF4"), e(f, "cornerRadius", 12), _(S, w), e(S, "draggable", true), e(S, "release", "glide"), e(S, "width", 60), e(S, "height", 60), e(S, "background", "#FF0A84FF"), e(S, "cornerRadius", 14), e(S, "onPanEnd", (I, N) => p(`${I.toFixed(0)}, ${N.toFixed(0)}`)), e(w, "label", "glide"), e(w, "fontSize", 11), e(w, "color", "#FFFFFFFF"), f;
        })(), (() => {
          var f = l("text");
  ...
  function dl() {
    const [t, r] = K("material"), [n, o] = K(false), [a, u] = K(true), [d, b] = K(false), [h, p] = K(40), [A, P] = K(""), [D, m] = K("none yet"), [x, E] = K(0), [z, j] = K(["Item one", "Item two", "Item three", "Item four"]);
    let T = 0;
    const [$, f] = K([]), [S, w] = K([]), [I, N] = K("M"), [V, ae] = K([]), [te, be] = K(0), [ie, pe] = K(false), [Ye, bt] = K(0), [or, Ze] = K(0), [kt, Hr] = K(false), [ge, It] = K("\u2014"), [Dt, Gr] = K("0, 0"), [jr, pt] = K("\u2014"), [Me, $e] = K(1);
    let lr = 1;
    const [ar, me] = K("\u2014 try a dialog button \u2014"), [Qe, zt] = K("\u2014 no date / time picked \u2014"), [sr, qr] = K(["First item", "Second item", "Third item", "Fourth item"]), cr = zr({ list: { component: (F) => L(sl, { get router() {
      return F.router;
    } }), title: "Mailboxes" }, detail: (F) => L(cl, { get name() {
      return F.params.name;
    }, get router() {
      return F.router;
    } }) }, "list"), [Nt, Lt] = K(0), Ft = (F, v) => {
      r(F), o(v), io(F, v ? 1 : 0);
      ...
      return (() => {
        ...
        return _(v, O), _(v, k), _(v, C), e(v, "background", "#FFF2F2F7"), e(v, "padding", 16), e(v, "gap", 14), e(v, "scrollbar", true), e(O, "label", "Skal \u2014 Component Demo"), e(O, "fontSize", 24), e(O, "fontWeight", 800), e(O, "color", "#FF1C1C1E"), e(k, "label", "Every fast-path widget, plus animation, the design system, and dialogs."), e(k, "fontSize", 13), e(k, "color", "#FF8E8E93"), B(v, L(X, { title: "Design system \u2014 setDesign()", get children() {
          ...
          return [(() => {
            ...
            var i = l("listView");
            return e(i, "axis", 1), e(i, "height", 66), e(i, "gap", 8), B(i, L(oe, { each: [Oe, Le, Je, _t, Ot, "#FF00C7BE", "#FFAF52DE", "#FFFFD60A"], children: (s) => (() => {
              var c = l("box");
          ...
          return [(() => {
            ...
            })() })), e(H, "crossAxisCount", 3), e(H, "aspectRatio", 1), e(H, "gap", 8), B(H, L(oe, { each: [Oe, Le, Je, _t, Ot, Oe, Le, Je, _t], children: (J) => (() => {
              var q = l("box");
          ...
          return [(() => {
            ...
            return _(i, s), e(i, "background", "#FFFFFFFF"), e(i, "cornerRadius", 12), e(i, "borderWidth", 1), e(i, "borderColor", "#FFE5E5EA"), e(i, "padding", 10), e(s, "width", 300), e(s, "height", 170), e(s, "draw", (c) => {
              c.strokeStyle(al).lineWidth(2).beginPath().moveTo(16, 150).lineTo(284, 150).stroke(), [50, 95, 70, h() + 10, 80].forEach((g, y) => {
                c.fillStyle(y === 3 ? Oe : _t).fillRect(28 + y * 52, 150 - g, 34, g);
            ...
            var i = l("row"), s = l("button"), c = l("button");
            return _(i, s), _(i, c), e(i, "gap", 8), e(s, "label", "Draw a shape"), e(s, "onClick", () => f([...$(), { x: 24 + Math.random() * 252, y: 16 + Math.random() * 120, r: 8 + Math.random() * 20, color: [Oe, Le, Je, Ot, _t][Math.floor(Math.random() * 5)] }])), e(c, "label", "Clear"), e(c, "onClick", () => f([])), i;
          })(), (() => {
            var i = l("text");
          ...
          return [(() => {
            ...
            return _(i, s), _(i, c), e(i, "gap", 8), e(s, "label", "Priority"), e(s, "fontSize", 13), e(s, "color", "#FF1C1C1E"), _(c, g), _(c, y), _(c, W), e(c, "onChange", (H) => bt(H)), e(g, "label", "Low"), e(g, "fontSize", 13), e(y, "label", "Medium"), e(y, "fontSize", 13), e(W, "label", "High"), e(W, "fontSize", 13), G((H) => e(c, "activeTab", Ye(), H)), i;
          })(), (() => {
          ...
          return [(() => {
            var i = l("box"), s = l("text");
            return _(i, s), e(i, "height", 70), e(i, "background", "#FFEFEFF4"), e(i, "cornerRadius", 12), e(i, "padding", 16), e(i, "onPanStart", () => pt("drag started")), e(i, "onPanUpdate", (c, g) => pt(`dx ${c.toFixed(1)}  dy ${g.toFixed(1)}`)), e(i, "onPanEnd", (c, g) => pt(`fling v ${c.toFixed(0)}, ${g.toFixed(0)} dp/s`)), e(s, "label", "Drag anywhere on this strip"), e(s, "fontSize", 13), e(s, "color", "#FF1C1C1E"), i;
          })(), (() => {
            var i = l("text");
    ...
    return (() => {
      ...
      return _(p, A), _(p, P), _(p, D), e(p, "background", "#FFF2F2F7"), e(p, "padding", 16), e(p, "gap", 14), e(A, "label", "Libraries \u2014 codegen-wrapped widgets"), e(A, "fontSize", 24), e(A, "fontWeight", 800), e(A, "color", "#FF1C1C1E"), e(P, "label", "Custom adapters + real pub.dev packages, brought into JSX by skal_codegen. Imported from 'skal-flutter'."), e(P, "fontSize", 13), e(P, "color", "#FF8E8E93"), B(p, L(X, { title: "Greeting \u2014 hand-written adapter", get children() {
        ...
        return [(() => {
          ...
          return _(m, x), _(m, E), _(m, z), _(m, j), _(m, T), _(m, $), _(m, f), _(m, S), e(m, "gap", 6), e(x, "label", "pause"), e(x, "onClick", async () => {
      ...
      return _(d, b), _(d, h), _(d, p), e(d, "background", "#FFF2F2F7"), e(d, "padding", 16), e(d, "gap", 14), e(d, "scrollbar", true), e(b, "label", "JS runtime \u2014 probes & timings"), e(b, "fontSize", 24), e(b, "fontWeight", 800), e(b, "color", "#FF1C1C1E"), e(h, "label", "Each function runs in the embedded bun + JSC runtime; its duration and response are logged. Bun / bun:sqlite probes report an error (not a crash) if the runtime doesn't expose them."), e(h, "fontSize", 13), e(h, "color", "#FF8E8E93"), e(p, "onClick", u), B(d, L(oe, { each: Zn, children: (A) => L(X, { get title() {
        ...
        return L(oe, { get each() {
          ...
          return (() => {
            ...
            return _(x, E), _(x, z), _(x, j), e(x, "gap", 2), e(E, "fontSize", 13), e(E, "fontWeight", 700), e(E, "color", "#FF1C1C1E"), e(z, "fontSize", 11), e(z, "fontWeight", 700), e(z, "color", "#FF0A84FF"), e(j, "fontSize", 12), e(j, "maxLines", 3), G((T) => {
