...
(function() {
  ...
  var we = (t, e) => t === e, wt = Symbol("solid-proxy"), Pe = typeof Proxy == "function", Te = Symbol("solid-track"), ot = { equals: we }, Mt = null, be = Zt, k = 1, et = 2, $t = { owned: null, cleanups: null, context: null, owner: null }, b = null, u = null, nt = null, z = null, R = null, C = null, N = null, at = 0;
  function ut(t, e) {
    const n = R, r = b, i = t.length === 0, l = e === undefined ? r : e, f = i ? $t : { owned: null, cleanups: null, context: l ? l.context : null, owner: l }, h = i ? t : () => t(() => Z(() => $(f)));
    b = f, R = null;
    try {
      return U(h, true);
    } finally {
  ...
  function Re(t) {
    ...
    return Promise.resolve().then(() => {
      R = e, b = n;
      let r;
      return (nt || ye) && (r = u || (u = { sources: new Set, effects: [], promises: new Set, disposed: new Set, queue: new Set, running: true }), r.done || (r.done = new Promise((i) => r.resolve = i)), r.running = true), U(t, false), R = b = null, r ? r.done : undefined;
    });
  }
  ...
  function ct(t) {
    ...
    Kt(t, u && u.running && u.sources.has(t) ? t.tValue : t.value, e), u && !u.running && u.sources.has(t) && queueMicrotask(() => {
      U(() => {
        u && (u.running = true), R = b = t, Kt(t, t.tValue, e), R = b = null;
      }, false);
    });
  }
  function Kt(t, e, n) {
    ...
    try {
      ...
      return t.pure && (u && u.running ? (t.tState = k, t.tOwned && t.tOwned.forEach($), t.tOwned = undefined) : (t.state = k, t.owned && t.owned.forEach($), t.owned = null)), t.updatedAt = n + 1, Tt(f);
    } finally {
      R = l, b = i;
    }
  ...
  function zt(t, e, n, r = k, i) {
    const l = { fn: t, state: r, updatedAt: null, owned: null, sources: null, sourceSlots: null, cleanups: null, value: e, owner: b, context: b ? b.context : null, pure: n };
    if (u && u.running && (l.state = 0, l.tState = r), b === null || b !== $t && (u && u.running && b.pure ? b.tOwned ? b.tOwned.push(l) : b.tOwned = [l] : b.owned ? b.owned.push(l) : b.owned = [l]), z && l.fn) {
  ...
  function Ae(t) {
    ...
    const n = N;
    N = null, n.length && U(() => be(n), false), e && e();
  }
  function Zt(t) {
  ...
  var Ge = 2 * 1024 * 1024, We = 64, Vn = We, ie = 1024 * 1024, Q = 64 + ie, se = 512 * 1024, Rt = Q + se, Ve = Q + se, Ue = 0, Me = 8, $e = 12, Ye = 16, Xe = 24, qe = 28, je = Me >> 2, Ke = $e >> 2, ze = Xe >> 2, le = qe >> 2, Ze = Ue >> 3, Qe = Ye >> 3, Un = 1, Mn = 2, $n = 3, Yn = 16, Xn = 17, qn = 20, jn = 21, Kn = 22, zn = 32, Zn = 33, Qn = 34, Jn = 35, tr = 36, er = 37, nr = 0, rr = 1, ir = 2, sr = 3, lr = 4, or = 5, ar = 6, ur = 1, fr = 0, cr = 1, hr = 2, gr = 3, vr = 4, _r = 5, dr = 6, Er = 7, Sr = 8, Or = 9, pr = 32, wr = 33, Pr = 34, Tr = 35, br = 36, Rr = 37, yr = 64, Ar = 65, Ir = 66, mr = 67, Cr = 68, Fr = 69, xr = 70, Nr = 96, Lr = 97, kr = 128, Dr = 129, Hr = 130, Br = 131, Gr = 160, Wr = 161, Vr = 162, Ur = -1, Je = 2147483646, tn = 2147483645, Y = globalThis.__skal_acquireBridge();
  ...
  var X = 8192, T = new Int8Array(256);
  ...
  function Bn() {
    ...
    return (() => {
      var v = L("lazyColumn"), p = L("box"), c = L("row"), I = L("button"), A = L("button"), y = L("button"), _ = L("row");
