...
Widget _build_Tiles(NodeState n, SkalBridge bridge) {
  return _skalApplyBaseProps(
    n,
    Tiles(
      provider: TileSource('osm'),
      urlTemplate: n.getCustomPropStr('urlTemplate') ?? '',
      maxZoom: n.getCustomPropF32('maxZoom', 18.0),
      retina: n.getCustomPropU32('retina', 0) != 0,
    ),
  );
}

void registerAll() {
  SkalRegistry.registerWidget('tiles', _build_Tiles);
}
