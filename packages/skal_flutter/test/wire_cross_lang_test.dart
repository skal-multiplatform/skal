...
// packages/skal-js/src/bridge.js side by side and asserts every SHARED
...
void main() {
  group('wire constants — cross-language (wire.dart ↔ bridge.js)', () {
    ...
    final bridgeFile = File('../../packages/skal-js/src/bridge.js');
    ...
    test('source files are present', () {
      ...
      expect(bridgeFile.existsSync(), isTrue,
          reason: 'expected ../../packages/skal-js/src/bridge.js relative to the '
              'package root');
    });
